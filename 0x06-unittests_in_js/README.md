...
```
vagrant@magma:~$ npm test 0-calcul.test.js
...
```
vagrant@magma:~/8-api$  node api.js
...
```
vagrant@magma:~/8-api$  curl http://localhost:7865 ; echo ""
Welcome to the payment system
vagrant@magma:~/8-api$
vagrant@magma:~/8-api$ npm test api.test.js
...
```
vagrant@magma:~$ curl http://localhost:7865/cart/12 ; echo ""
Payment methods for cart 12
vagrant@magma:~$
vagrant@magma:~$ curl http://localhost:7865/cart/hello -v
*   Trying 127.0.0.1...
* TCP_NODELAY set
...
```
vagrant@magma:~$ curl http://localhost:7865/available_payments ; echo ""
{"payment_methods":{"credit_cards":true,"paypal":false}}
vagrant@magma:~$
vagrant@magma:~$ curl -XPOST http://localhost:7865/login -d '{ "userName": "Betty" }' -H 'Content-Type: application/json' ; echo ""
Welcome Betty
vagrant@magma:~$
